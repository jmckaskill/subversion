...
#define SVN_UTF8_A_STR           "\x41" /* "A" */
#define SVN_UTF8_B_STR           "\x42" /* "B" */
#define SVN_UTF8_C_STR           "\x43" /* "C" */
#define SVN_UTF8_D_STR           "\x44" /* "D" */
#define SVN_UTF8_E_STR           "\x45" /* "E" */
#define SVN_UTF8_F_STR           "\x46" /* "F" */
#define SVN_UTF8_G_STR           "\x47" /* "G" */
#define SVN_UTF8_H_STR           "\x48" /* "H" */
#define SVN_UTF8_I_STR           "\x49" /* "I" */
#define SVN_UTF8_J_STR           "\x4A" /* "J" */
#define SVN_UTF8_K_STR           "\x4B" /* "K" */
#define SVN_UTF8_L_STR           "\x4C" /* "L" */
#define SVN_UTF8_M_STR           "\x4D" /* "M" */
#define SVN_UTF8_N_STR           "\x4E" /* "N" */
#define SVN_UTF8_O_STR           "\x4F" /* "O" */
#define SVN_UTF8_P_STR           "\x50" /* "P" */
#define SVN_UTF8_Q_STR           "\x51" /* "Q" */
#define SVN_UTF8_R_STR           "\x52" /* "R" */
#define SVN_UTF8_S_STR           "\x53" /* "S" */
#define SVN_UTF8_T_STR           "\x54" /* "T" */
#define SVN_UTF8_U_STR           "\x55" /* "U" */
#define SVN_UTF8_V_STR           "\x56" /* "V" */
#define SVN_UTF8_W_STR           "\x57" /* "W" */
#define SVN_UTF8_X_STR           "\x58" /* "X" */
#define SVN_UTF8_Y_STR           "\x59" /* "Y" */
#define SVN_UTF8_Z_STR           "\x5A" /* "Z" */
#define SVN_UTF8_a_STR           "\x61" /* "a" */
#define SVN_UTF8_b_STR           "\x62" /* "b" */
#define SVN_UTF8_c_STR           "\x63" /* "c" */
#define SVN_UTF8_d_STR           "\x64" /* "d" */
#define SVN_UTF8_e_STR           "\x65" /* "e" */
#define SVN_UTF8_f_STR           "\x66" /* "f" */
#define SVN_UTF8_g_STR           "\x67" /* "g" */
#define SVN_UTF8_h_STR           "\x68" /* "h" */
#define SVN_UTF8_i_STR           "\x69" /* "i" */
#define SVN_UTF8_j_STR           "\x6A" /* "j" */
#define SVN_UTF8_k_STR           "\x6B" /* "k" */
#define SVN_UTF8_l_STR           "\x6C" /* "l" */
#define SVN_UTF8_m_STR           "\x6D" /* "m" */
#define SVN_UTF8_n_STR           "\x6E" /* "n" */
#define SVN_UTF8_o_STR           "\x6F" /* "o" */
#define SVN_UTF8_p_STR           "\x70" /* "p" */
#define SVN_UTF8_q_STR           "\x71" /* "q" */
#define SVN_UTF8_r_STR           "\x72" /* "r" */
#define SVN_UTF8_s_STR           "\x73" /* "s" */
#define SVN_UTF8_t_STR           "\x74" /* "t" */
#define SVN_UTF8_u_STR           "\x75" /* "u" */
#define SVN_UTF8_v_STR           "\x76" /* "v" */
#define SVN_UTF8_w_STR           "\x77" /* "w" */
#define SVN_UTF8_x_STR           "\x78" /* "x" */
#define SVN_UTF8_y_STR           "\x79" /* "y" */
#define SVN_UTF8_z_STR           "\x7A" /* "z" */
/* Numerics */
 ...
 * back and forth is unfortunately common in the iSeries port but that's
 * another issue).  Otherwise converting from utf-8 to ebcdic with
 * svn_utf_string_from_utf8 is a one way trip; mutlibyte utf-8 sequences in
 * these cases get reduced to single ebcdic byte and there is no going back to
 * the original utf-8 value with svn_utf_string_to_utf8.
 */
