...
/* Module Description ************************************************/
/*                                                                   */
/* Source File Name:  mod_dav.h                                      */
/*                                                                   */
/* Change Activity:                                                  */
/*                                                                   */
/* CFD List:                                                         */
/*                                                                   */
/*   $A0=TTTTTTTTT RRRRRRRRRR     YYDDMM  Userid    Comments         */
/*   $A1=P9A38748  v5r3m0.dgo     030909  KKRICH: Use #pragma for     */
/*                                        enum so compares for file type*/
/*                                        work correctly.            */
...
#ifdef AS400
    /* Get rid of the  charset ="utf-8", so we translate our XML responses, since we build them in the job/server CCSID, and they need to be translated..  */
#define DAV_XML_CONTENT_TYPE	"text/xml"
#else
...
#ifdef AS400  /* */
/* '!' is variant in EBCDIC.  We will substitute the correct one at runtime. */
...
*/
#ifdef AS400
/* we need to make sure all the enum values are int since for some reason
the resource->type doesn't work without this @A1A*/
#pragma enum(4)
#endif
typedef enum {
