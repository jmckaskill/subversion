...
/**
 * this is the interface for requesting authentification information from the user. Should the javahl bindings need
 * the matching information, these methodes will be called.
 */
