 ...
 *
 * Output a @a diff between @a original_path, @a modified_path and @a latest_path
 * in merged format to @a output_file.  Optionally supply @a conflict_start,
 * @a conflict_seperator and/or @a conflict_end to be displayed as conflict
 * markers in the output.
 * If @a conflict_start, @a conflict_seperator or @a conflict_end is @c NULL, a
