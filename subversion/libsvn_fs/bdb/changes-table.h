...
int svn_fs__open_changes_table (DB **changes_p,
                                DB_ENV *env,
                                int create);
...
svn_error_t *svn_fs__changes_add (svn_fs_t *fs,
                                  const char *key,
...
/* Remove all changes associated with KEY from the `changes' table in
   FS, as part of TRAIL. */
svn_error_t *svn_fs__changes_delete (svn_fs_t *fs,
                                     const char *key,
                                     trail_t *trail);
...
/* Return an array *CHANGES_P of svn_fs__change_t * items representing
   ...
   Allocate the array and its items in TRAIL->pool.  */
svn_error_t *svn_fs__changes_fetch_raw (apr_array_header_t **changes_p,
                                        svn_fs_t *fs,
                                        const char *key,
                                        trail_t *trail);
